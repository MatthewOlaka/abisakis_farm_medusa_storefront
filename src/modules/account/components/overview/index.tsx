		...
		<div data-testid="overview-page-wrapper">
			<div className="hidden small:block">
				<div className="flex justify-between items-center mb-4">
					<span
						className="text-3xl font-serif font-bold text-green-900"
						...
						<div className="flex items-start gap-x-16 mb-6">
							<div className="flex flex-col gap-y-4">
								...
								<div className="flex items-end gap-x-2">
									<span
										className="text-5xl font-serif text-green-900 leading-none"
										data-testid="customer-profile-completion"
										data-value={getProfileCompletion(customer)}
									>
										{getProfileCompletion(customer)}%
									</span>
									<span className="uppercase text-base-regular text-green-900">Completed</span>
								</div>
							</div>
							...
							<div className="flex flex-col gap-y-4">
								...
								<div className="flex items-end gap-x-2">
									<span
										className="text-5xl font-serif text-green-900"
										...
										return (
											<li key={order.id} data-testid="order-wrapper" data-value={order.id}>
												<LocalizedClientLink href={`/account/orders/details/${order.id}`}>
													<Container className="bg-yellow-200/80 flex justify-between items-center p-4">
														<div className="grid grid-cols-3 grid-rows-2 text-small-regular gap-x-4 flex-1">
															<span className="font-semibold text-green-900">Date placed</span>
