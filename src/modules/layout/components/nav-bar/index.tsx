    ...
    <>
      ...
      <div className="shy-header sticky top-0 z-[999] bg-[#fffdee]">
        <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-row-reverse md:flex-row items-center gap-x-6">
            <NavLinks />
            <div className="flex gap-4 h-full">
              <LocalizedClientLink
                ...
                >
                <FontAwesomeIcon icon={faUser} className="text-2xl text-gray-700 hover:scale-125 hover:text-amber-500 transition"/>
                {/* <h2>account</h2> */}
              </LocalizedClientLink>
              ...
              <Suspense
                fallback={
                  ...
                  >
                    {/* Cart (0) */}
                    {<FontAwesomeIcon icon={faShoppingBag} className="text-xl text-gray-700 hover:scale-125 hover:text-amber-500 transition"/>}
                  </LocalizedClientLink>
                }
                >
                <CartButton />
